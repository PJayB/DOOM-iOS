...
/* JDC static */ fixed_t m_x, m_y;     // LL x,y window location on the map (map coords)
/* JDC static */ fixed_t m_x2, m_y2;   // UR x,y window location on the map (map coords)

//
// width/height of window on map (map coords)
//
/* JDC static */ fixed_t  m_w;
/* JDC static */ fixed_t  m_h;
...
/* JDC static */ fixed_t  min_scale_mtof; // used to tell when to stop zooming out
/* JDC static */ fixed_t  max_scale_mtof; // used to tell when to stop zooming in
...
/* JDC static */ fixed_t scale_mtof = (fixed_t)INITSCALEMTOF;
// used by FTOM to scale from frame-buffer-to-map coords (=1/scale_mtof)
/* JDC static */ fixed_t scale_ftom;
